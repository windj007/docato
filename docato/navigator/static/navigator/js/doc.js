...
var project_id = $('.navigator #project_id').html();
var subject_id = $('.navigator #subject_id').html();
var doc_id = $('.navigator #doc_id').html();
var change_project = $('.navigator #change_project').html() == '1';
var csrf_name = 'csrfmiddlewaretoken';
var csrf_value = $('.navigator [name="' + csrf_name + '"]').attr('value');
var csrf_args = {};

...
from navigator.utils import get_unique_model_name, try_get_reference, get_value, ValuesTypes
...
class ClassLabelSlot(BaseSlot):
    template_name = 'navigator/typesystem/slots/class_label.html'
...
class IntegerSlot(BaseSlot):
    template_name = 'navigator/typesystem/slots/integer.html'
    type_name = _('Integer')
...
class RealSlot(BaseSlot):
    template_name = 'navigator/typesystem/slots/real.html'
    type_name = _('Real')
...
class ObjectSlot(BaseSlot):
    template_name = 'navigator/typesystem/slots/object.html'

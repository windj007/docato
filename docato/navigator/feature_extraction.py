...
from navigator.utils import get_sval_color_style
...
def highlight_features(doc):
    ...
    head.append(head.makeelement('link',
                                 attrib = {
                                           'rel' : 'stylesheet',
                                           'type' : 'text/css',
                                           'href' : settings.STATIC_URL + 'navigator/css/converted.css'
                                           }))
    head.append(head.makeelement('link',
                                 attrib = {
                                           'rel' : 'stylesheet',
                                           'type' : 'text/css',
                                           'href' : settings.STATIC_URL + 'navigator/css/background-colors.css'
                                           }))
    head.append(head.makeelement('link',
                                 attrib = {
                                           'rel' : 'stylesheet',
                                           'type' : 'text/css',
                                           'href' : settings.STATIC_URL + 'navigator/css/border-colors.css'
                                           }))
    head.append(head.makeelement('link',
                                 attrib = {
                                           'rel' : 'stylesheet',
                                           'type' : 'text/css',
                                           'href' : settings.STATIC_URL + 'navigator/css/contextMenu.css'
                                           }))
    head.append(head.makeelement('script',
                                 attrib = {
                                           'type' : 'text/javascript',
                                           'src' : settings.STATIC_URL + 'navigator/js/jquery-1.9.1.js'
                                           }))
    head.append(head.makeelement('script',
                                 attrib = {
                                           'type' : 'text/javascript',
                                           'src' : settings.STATIC_URL + 'navigator/js/contextMenu.min.js'
                                           }))
    head.append(head.makeelement('script',
                                 attrib = {
                                           'type' : 'text/javascript',
    ...
    head.append(head.makeelement('script',
                                 attrib = {
                                           'type' : 'text/javascript',
                                           'src' : settings.STATIC_URL + 'navigator/js/converted.js'
                                           }))
